...
<html>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            ...
                                                            <strong>Hola {{$order->email}}</strong> 
                                                               Actualizo la info de tu pedido 
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
 ...
 <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                    Si algun datos esta mal comunicate a ayuda @ElPonchoRobles
                                                                    <a href="mailto:solo-metro@hotmail.com"></a>
                                                                  </td>
                                                                  </tr>
                                                     <tr mc:repeatable>
                                                               
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                    Te enviaremos un correo cuando haya actualizaciones de tu pedido
                                                                  </td>
                                                                  </tr>
...
<a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Para mas informacion del pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2017 AlfonsoRdzCodeBox,
